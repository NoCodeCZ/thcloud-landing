const en = {
  ...
  home: {
    ...
    finalCta: {
      ...
      body: "The first step is a discovery session. We map your current data landscape, identify the highest-value integrations, and scope the build. No commitment required.",
  ...
  thankYou: {
    ...
    options: {
      demo: {
        ...
        description: "30-min call. We map your data landscape and show you what the system looks like for your business.",
        href: "https://cal.tonghuagroup.com/tatchat",
        badge: "Recommended",
      },
      webinar: {
        label: "Watch the Webinar",
        description: "See the full 5-layer AI system running live in a real Thai business — in 30 minutes.",
      },
    },
